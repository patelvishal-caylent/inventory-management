export default {
  ...
  orders: {
    ...
    noSubmittedOrders: '送信済みの補充発注はまだありません',
    totalOrders: '総注文数',
    totalRevenue: '総収益',
    avgOrderValue: '平均注文額',
    onTimeDelivery: '定時配達',
  ...
  restocking: {
    title: '補充発注',
    description: '需要予測に基づき予算内で補充発注を計画します',
    budgetTitle: '補充予算',
    itemsSelected: '選択品目数',
    totalCost: '合計金額',
    budgetRemaining: '予算残高',
    uncoveredCost: '未充足の不足額',
    recommendations: '推奨補充リスト',
    noShortages: '現在のフィルター条件では不足はありません',
    included: '対象',
    overBudget: '予算超過',
    placeOrder: '発注する',
    placing: '発注処理中...',
    orderPlaced: '補充発注 {orderNumber} を送信しました。納品予定日: {expectedDelivery}',
    table: {
      sku: 'SKU',
      itemName: '品目名',
      onHand: '在庫数',
